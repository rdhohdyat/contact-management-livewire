...
<div x-data="{ open: false }" class="border border-gray-700 rounded-md overflow-hidden">
    ...
    <button @click="open = !open"
        ...
        <svg :class="open ? 'rotate-180' : ''" class="w-4 h-4 text-gray-300 transition-transform duration-300"
    ...
    <!-- Content -->
    <div x-show="open" x-collapse x-cloak class="bg-gray-800 border-t border-gray-700">
