        ...
        <div class="">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-100 dark:bg-gray-800">
                    <tr>
                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">No</th>
                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Nama</th>
                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Kelas
                        </th>
                        <th class="px-4 py-2 text-left text-sm font-semibold text-gray-700 dark:text-gray-200">Aksi</th>
                    </tr>
                </thead>
                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                    <tr>
                        <td class="px-4 py-3 text-sm text-gray-800 dark:text-gray-200">1</td>
                        <td class="px-4 py-3 text-sm text-gray-800 dark:text-gray-200">Ridho Hidayat</td>
                        <td class="px-4 py-3 text-sm text-gray-800 dark:text-gray-200">TIE</td>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="first_name" name="first_name" class="input" placeholder="Enter first name">
                    </div>
                </div>
                <div>
