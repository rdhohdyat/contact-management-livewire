        ...
        <div class="mb-4">
            ...
            <div class="relative">
                ...
                <input wire:model="username" type="text" id="username" name="username"
                    class="{{ $errors->has('username') ? 'input-error' : 'input' }}" placeholder="Choose a username">
            </div>
            @error('username')
        ...
        <div class="mb-4">
            ...
            <div class="relative">
                ...
                <input wire:model="name" type="text" id="name" name="name"
                    class="{{ $errors->has('name') ? 'input-error' : 'input' }}" placeholder="Enter your full name">
            </div>
            @error('name')
                <span class="input-error-text">{{ $message }}</span>
            @enderror
        ...
        <div class="mb-4">
            ...
            <div class="relative">
                ...
                <input wire:model="password" type="password" id="password" name="password"
                    class="{{ $errors->has('password') ? 'input-error' : 'input' }}" placeholder="Create a password">
            </div>
            @error('password')
                <span class="input-error-text">{{ $message }}</span>
            @enderror
